...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><small> <b>Informasi Kunjungan Tamu RSUD dr. Darsono Kabupaten
                        Pacitan</b></small></h1>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Kunjungan
                                    (Month)
                                </div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $bulans }}
                                        </div>
                                    </div>
                                    <div class="col">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="chart-area">
                            ...
                            <canvas id="chart" width="60rem" height="30rem"
                                style="display: block; width: 60rem; height: 320px;"
                                class="chartjs-rendor-monitor"></canvas>
                        </div>
                    </div>
                </div>
            </div>
